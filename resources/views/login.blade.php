    ...
    <header>
      <nav class="navbar navbar-expand-lg" style="background-color:#BDFCC9;">
        ...
        <div class="Collapse navbar-nav ml-auto">
          <ul class="navbar-nav">
            <li class="nav-item">
              <a class="nav-link" href="{{route('signup')}}" style="color: black;">Create Account</a>
            </li>
            <li class="nav-item">
              <a class="nav-link text-info" href="" style="color: black;">Login</a>
            </li>
          </ul>
        </div>
      </nav>
...
<div class="heading animate__animated animate__fadeInUp">
  <h2 class="display-6">Login to the Website!</h2>
</div>

<div class="form animate__animated animate__fadeInUp">
  <form class = "mb-4" action="{{route('login_user')}}" method="post">
    @csrf
